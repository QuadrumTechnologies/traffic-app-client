...
var IntersectionConfiguration = function (_a) {
    ...
    react_1.useEffect(function () {
        dispatch(SignalConfigSlice_1.setManualMode(!(deviceActiveStateData === null || deviceActiveStateData === void 0 ? void 0 : deviceActiveStateData.Auto)));
        setShowManualMoreConfig(!(deviceActiveStateData === null || deviceActiveStateData === void 0 ? void 0 : deviceActiveStateData.Auto));
    }, [dispatch, deviceActiveStateData === null || deviceActiveStateData === void 0 ? void 0 : deviceActiveStateData.Auto]);
    ...
    if (showCommandsOnly) {
        return (React.createElement("div", null,
            React.createElement("div", null,
                ...
                showManualMoreConfig && (React.createElement("div", { className: "phases__buttonBox" },
                ...
                showManualMoreConfig && (React.createElement("form", { onSubmit: formik.handleSubmit, className: "patterns__selected--form" },
                    initialSignalStrings.includes("G") && (React.createElement("div", null,
                    ...
                    React.createElement(Button_1["default"], { type: "submit" }, "Send Signal"))))));
    }
