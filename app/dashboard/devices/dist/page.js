...
var UserDevices = function () {
    var _a = reduxHook_1.useAppSelector(function (state) { return state.userDevice; }), devices = _a.devices, isFetchingDevices = _a.isFetchingDevices, deviceStatuses = _a.deviceStatuses;
    var dispatch = reduxHook_1.useAppDispatch();
    useDeviceStatus_1.useDeviceStatus();
    ...
    var _e = react_1.useState(true), showSpinner = _e[0], setShowSpinner = _e[1];
    ...
    var handleRedirectionToDevicePage = function (deviceId) {
        ...
        dispatch(UserDeviceSlice_1.getUserDeviceInfoData(deviceId));
    ...
    return (React.createElement("aside", { className: "devices" },
        ...
        React.createElement("div", { className: "devices-list" }, devices === null || devices === void 0 ? void 0 : devices.map(function (device, index) {
            var _a;
            var deviceStatus = deviceStatuses.find(function (s) { return s.id === (device === null || device === void 0 ? void 0 : device.id); });
            var status = misc_1.getDeviceStatus(deviceStatuses, device.deviceId);
            return (React.createElement("div", { key: index, className: "devices-item " + ((device === null || device === void 0 ? void 0 : device.status) === "disabled" ? "disabled" : "") },
                ...
                React.createElement("div", null,
                    ...
                    !(status === null || status === void 0 ? void 0 : status.status) && (React.createElement("div", { style: {
                            display: "flex",
                            justifyContent: "flex-end",
                            fontSize: "1.4rem",
                            letterSpacing: "0.05rem",
                            color: "#888"
                        } }, (deviceStatus === null || deviceStatus === void 0 ? void 0 : deviceStatus.lastSeen) || (status === null || status === void 0 ? void 0 : status.lastSeen) || (device === null || device === void 0 ? void 0 : device.lastSeen)
                        ? "Last seen: " + dayjs_1["default"]((deviceStatus === null || deviceStatus === void 0 ? void 0 : deviceStatus.lastSeen) || (status === null || status === void 0 ? void 0 : status.lastSeen) || (device === null || device === void 0 ? void 0 : device.lastSeen)).format("YYYY-MM-DD HH:mm:ss")
